...
\subsection{Faltung}
\todo[inline]{Erkläre wie die Faltung im Kontext eines CNNs funktioniert}
...
\section{verwendete Datensets}
\todo[inline]{verwendete Datensets}
