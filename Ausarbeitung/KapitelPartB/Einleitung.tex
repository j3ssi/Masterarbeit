...
In Abbildung \ref{abb:baseAccS} ist abgebildet, wie sich die Accuracy für das schmallere Netz verhält, bei der gleichen Anpassung der Lernrate wie bei den breiteren Baseline-Netzen. Der Unterschied zwischen dem schmallen und breiten Baseline-Netz ist in Abbildung \ref{abb:baseAccV} abgebildet.

\begin{figure}[h]
 \includegraphics[width=0.5\textwidth]{KapitelPartB/Images/baseAccS.png}
 % baseAccS.png: 817x623 px, 96dpi, 21.62x16.49 cm, bb=0 0 613 467
 \caption{bb}
 \label{abb:baseAccS}
\end{figure}
