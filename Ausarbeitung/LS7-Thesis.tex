...
\newcommand \Author{Jessica B\"uhler}
...
\hypersetup
{
    ...
    pdfsubject = {\Thesistyp, TU Dortmund, Fakultät Informatik},
    pdfproducer = {LaTeX},
    pdfview = FitV,
    pdfstartview = FitV,
    pdfhighlight = /I,
...
% Front Page ---------------------------------------------------------
%
\pdfbookmark{Front page}{pdf:title}
\pagenumbering{alpha}
\pagestyle{empty}
\include{frontpage}
...
%
\pagestyle{empty}
\pdfbookmark{Mathematical Notation}{pdf:Notation}
\include{notation}
\cleardoublepage
...
\cleardoublepage
\include{KapitelPartA/Einleitung}

\include{KapitelPartA/Arithmetik}

\include{KapitelPartA/Gradient}

\include{KapitelPartA/Trainingsdaten}

\include{KapitelPartA/Struktur}

\include{KapitelPartA/Andere}



\cleardoublepage
\include{KapitelPartB/Einleitung}

\include{KapitelPartB/Durchfuehrung}
