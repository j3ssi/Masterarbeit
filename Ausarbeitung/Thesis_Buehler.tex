...
\RequirePackage{ifpdf} \ifpdf
  ...
  \documentclass[pdftex,12pt,a4paper,twoside,numbers=noenddot,xcolor=dvipsnames]{scrbook}
  \usepackage{float}
...
\input{KapitelPartA/Einleitung}

\input{KapitelPartA/Morphnet}

\input{KapitelPartA/Arithmetik}

\input{KapitelPartA/Gradient}

\input{KapitelPartA/Trainingsdaten}

\input{KapitelPartA/Struktur}

\input{KapitelPartA/Andere}



\cleardoublepage
\input{KapitelPartB/Einleitung}

\input{KapitelPartB/Experimente}

\input{KapitelPartB/Evaluation}
